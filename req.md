...
The game with grid size 
 and only ordinary discs can be successfully played from start to finish. 
The game with arbitrary grid size 
 can be successfully played from start to finish. 
...
Video demonstration
To demonstrate to us that your game is functional and you have followed the OOP principles, you will need to produce a short video. This video is only to show us your game in action and does not need to be polished. It is intended to be informal and maximise your opportunity to show us your work and your understanding of OOP.

Be sure that your video:

Is no longer than five (5) minutes  [Note: video length increased from 2 to 5 minutes]
...
Submit the video to YouTube and make it publicly viewable,  include the URL to your YouTube video  and your student name and ID in a Word or text file, then submit the file to the Canvas Assignment named "IFN584 Assignment 1 Video".

Alternatively you can submit the video file directly to the Canvas Assignment named "IFN584 Assignment 1 Video"  (only do this if you are not able to submit your video to YouTube).  
...
The submitted project files will be compiled and executed on QUT lab computers with .NET. You must make sure that your submitted code can be compiled and run properly under this environment.
